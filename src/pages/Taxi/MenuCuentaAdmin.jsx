...
const MenuCuentaAdmin = ({navigation}) => {
  ...
  */
  ...
  useEffect(() => {
    ...
    <View style={styles.container}>  
        <View style={{marginBottom: 0, width: "100%", paddingTop: 0}}>
        ...
        <View style={{width: "100%"}}>
            <TouchableOpacity  
                ...
                <View style={{flex: 1, flexDirection: "row", backgroundColor: "#F5F4F4", marginTop: 10, paddingVertical: 10, borderRadius: 10}}>
                    <View style={{width: "20%", justifyContent: "center", paddingHorizontal: 10, alignItems: "center"}}>
                        <Icon size={25} name="list" color="#A5281A"  />
                    </View>
                    <View style={{width: "68%", paddingTop: 3}}>
                        <Text style={{fontSize: 16, justifyContent: "center", textAlignVertical: "center"}}>
                            Gastos por gasolina
        ...
        <TouchableOpacity  
            ...
            >
                <View style={{flex: 1, flexDirection: "row", backgroundColor: "#F5F4F4", marginTop: 10, paddingVertical: 10, borderRadius: 10}}>
                    <View style={{width: "20%", justifyContent: "center", paddingHorizontal: 10, alignItems: "center"}}>
                        <Icon size={25} name="money-bill" color="#27AF7B"  />
                    </View>
            ...
            <View style={{flex: 1, flexDirection: "row", backgroundColor: "#F5F4F4", marginTop: 10, paddingVertical: 10, borderRadius: 10}}>
                <View style={{width: "20%", justifyContent: "center", paddingHorizontal: 10, alignItems: "center"}}>
                    <Icon size={35} name="user" color="#249C14"  />
                </View>
                <View style={{width: "68%", paddingTop: 5}}>
                    <Text style={{fontSize: 16, justifyContent: "center", textAlignVertical: "center"}}>
                        Datos personales
            ...
            <TouchableOpacity  
                onPress={() => {
                navigation.navigate({
                    name: 'UsuarioRequisitos'
                });
                }}
            >
                <View style={{flex: 1, flexDirection: "row", backgroundColor: "#F5F4F4", marginTop: 10, paddingVertical: 10, borderRadius: 10}}>
                    <View style={{width: "20%", justifyContent: "center", paddingHorizontal: 10, alignItems: "center"}}>
                        <Icon size={35} name="file" color="#BC4A30"  />
                    </View>
                    <View style={{width: "68%", paddingTop: 5}}>
                        <Text style={{fontSize: 16, justifyContent: "center", textAlignVertical: "center"}}>
                            Requisitos
            ...
            >
                <View style={{flex: 1, flexDirection: "row", backgroundColor: "#F5F4F4", marginTop: 10, paddingVertical: 10, borderRadius: 10}}>
                    <View style={{width: "20%", justifyContent: "center", paddingHorizontal: 10, alignItems: "center"}}>
                        <Icon size={35} name="question-circle" color="#D18018"  />
                    </View>
                    <View style={{width: "68%", paddingTop: 5}}>
                        <Text style={{fontSize: 16, justifyContent: "center", textAlignVertical: "center"}}>
                            Soporte
...
export default MenuCuentaAdmin