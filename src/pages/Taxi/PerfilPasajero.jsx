...
const PerfilPasajero = ({navigation, route}) => {
    ...
    const buscarUsuario = async (usuarioid) => { // Buscar usuario
        ...
        try {
            const resp = await axios.post(APP_URLAPI+'usuarioinfopasajero',
                {          
            ...
            ////console.log("usuarioinfopasajero ");
    ...
    <ScrollView> 
        <View>                 
            <Image 
                    ...
                    source={require('../../../assets/img/bannerpasajero.jpg')}
                  />   
        </View>                     
